...
<b-card-group deck
      class="mb-3">
<b-card bg-variant="dark" text-variant="white" title= "Addiction Helper">
  <p class="title-color">
...
<b-card bg-variant="dark" text-variant="white" title= "Age Uk">
  <p class="title-color">
    Age UK's helps millions of people to know their rights and make the best choices for later life.
    <br>
    <br>
  </p>
...
<b-card-group deck
      class="mb-3">
      <b-card bg-variant="dark" text-variant="white" title= "Anxiety UK">
  <p class="title-color">
      Support those living with anxiety and anxiety-based depression by providing information, support and understanding.
    <br>
    <br>
    <br>
  </p>
...
<b-card bg-variant="dark" text-variant="white" title= "Arthritis Care">
  <p class="title-color">
    United in our ambition to ensure that one day, no one will have to live with the pain, fatigue and isolation that arthritis causes.
    <br>
    <br>
    <br>
  </p>
...
<b-card bg-variant="dark" text-variant="white" title= "Asthma Uk">
  <p class="title-color">
    Asthma research charity, support helps understand the causes of asthma, reduce asthma attacks, find new treatments for severe asthma.
    <br>
    <br>
  </p>
  <b-button href="http://bit.ly/2Q3iVZj" target="_blank" variant="info">open</b-button>
      ...
      <b-card-group deck
      class="mb-3">
<b-card bg-variant="dark" text-variant="white" title= "Avert">
  <p class="title-color">
...
<b-card-group deck
      class="mb-3">
      <b-card bg-variant="dark" text-variant="white" title= "Crohns And Colitis">
  <p class="title-color">
...
<b-card bg-variant="dark" text-variant="white" title= "Diabetes">
  <p class="title-color">
    Aim is to raise awareness to all forms of diabetes,, preventative actions and manage both type 1 and type 2 diabetes.
    <br>
    <br>
  </p>
...
<b-card-group deck
      class="mb-3">
<b-card bg-variant="dark" text-variant="white" title= "Glaucoma">
  <p class="title-color">
    Provide information, literature, advice and fund essential research to prevent unnecessary loss of sight.
    <br>
    <br>
  </p>
...
<b-card-group deck
      class="mb-3">
      <b-card bg-variant="dark" text-variant="white" title= "LGBT">
  <p class="title-color">
      national charity delivering advice, support and information services to lesbian, gay, bisexual and trans communities.
    <br>
    <br>
...
<b-card bg-variant="dark" text-variant="white" title= "Macmillan">
  <p class="title-color">
    Information and support.
    <br>
    <br>
...
<b-card-group deck
      class="mb-3">
<b-card bg-variant="dark" text-variant="white" title= "Mens Health Forum">
  <p class="title-color">
...
<b-card-group deck
      class="mb-3">
      <b-card bg-variant="dark" text-variant="white" title= "Pancreatic Cancer">
  <p class="title-color">
      Information and support.
    <br>
    <br>
...
<b-card bg-variant="dark" text-variant="white" title= "Parkinsons">
  <p class="title-color">
      Parkinson's charity that drives better care, treatments and quality of life.
    <br>
    <br>
  </p>
...
<b-card-group deck
      class="mb-3">
      <b-card bg-variant="dark" text-variant="white" title= "Rethink">
  <p class="title-color">
      Better life for everyone affected by mental illness. See how we make a difference.
    <br>
    <br>
    <br>
  </p>
...
<b-card bg-variant="dark" text-variant="white" title= "Scope">
  <p class="title-color">
    Disability equality charity. Achieve a society where all disabled people enjoy equality and fairness.
    <br>
    <br>
  </p>
...
<b-card bg-variant="dark" text-variant="white" title= "Sense">
  <p class="title-color">
    Supports people with complex communication needs to be understood, connected and valued.
    <br>
    <br>
  </p>
...
<b-card-group deck
      class="mb-3">
      <b-card bg-variant="dark" text-variant="white" title= "Sicklecell Society">
  <p class="title-color">
      Supports and represents people affected by sickle cell disorder to improve their overall quality of life.
    <br>
    <br>
    <br>
  </p>
...
<b-card bg-variant="dark" text-variant="white" title= "Spark Support">
  <p class="title-color">
    spark up conversations between people about mental health. Connecting people together, to support each other through tough times, and celebrate the good.
    <br>
    <br>
  </p>
...
<b-card bg-variant="dark" text-variant="white" title= "Stroke">
  <p class="title-color">
    Support recovery with free access to trusted advice, information and support 24/7.
    <br>
    <br>
    <br>
    <br>
...
<b-card-group deck
      class="mb-3">
      <b-card bg-variant="dark" text-variant="white" title= "Sue Ryder">
  <p class="title-color">
...
<b-card bg-variant="dark" text-variant="white" title= "Terrence Higgins Trust">
  <p class="title-color">
...
<b-card-group deck
      class="mb-3">
      <b-card bg-variant="dark" text-variant="white" title= "Uk-Rehab">
  <p class="title-color">
...
<b-card bg-variant="dark" text-variant="white" title= "webmd">
  <p class="title-color">
    Health advice.
    <br>
    <br>
